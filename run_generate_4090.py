...
SRC_ROOT = Path(r'.\examples\wan_animate\replace\process_results_896x512')
...
print(f"[Generate] target {896}x512, clip_len=32, steps=10 (runtime will auto-align as needed)")
